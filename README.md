...
Backend service for an e-commerce platform using Golang and PostgreSQL. It provides APIs for user authentication, product management, cart functionality, and order processing. <img src="https://matimortari.github.io/assets/dancing-gopher.gif" alt="Gopher" width="25" height="25">
